...
const pointsBinary = document.getElementById('points-binary');
const bytes = document.getElementById('bytes');

const encoder = new TextEncoder();

// All invisible Unicode characters. Copied from VSCode source code:
// https://github.com/microsoft/vscode/blob/main/src/vs/base/common/strings.ts#L1192
